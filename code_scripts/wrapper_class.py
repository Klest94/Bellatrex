    ...
    class Estimator:
        ...
        class Tree_:
            def __init__(self, feature, n_node_samples, children_left, 
                         ...
                         feature_names_in_, learner_class):
...
def DT_to_dict(clf_obj, idx, output_format, T_to_bin=2):
    ...
    elif isinstance(tree_obj, DecisionTreeClassifier) and tree_obj.n_outputs_ == 1 and output_format in ["probability", "auto"]:
    ...
    elif isinstance(tree_obj, DecisionTreeRegressor) and tree_obj.n_outputs_ == 1 and output_format in ["probability", "auto"]:
